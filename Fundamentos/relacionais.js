...
//deu false pq são genericamente iguais, não está comparando o tipo
console.log ("03)", "3" != 3)
...
const d2 = new Date (0)
//por ser uma variável de referência de memória não faz diferença se usar o estritamente igual ou igual, pois compara referência de memória
