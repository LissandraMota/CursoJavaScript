...
console.log(escola.charAt(5)) //como não xiste esse caractere retorna vazio
//JS é uma linguagem mais relaxada não gera erro direto, como no caso acima

console.log(escola.charCodeAt(3))//dar como resultado o cóigo rlacionado a tabela unicode, com relação ao índice dado da string
 console.log(escola.indexOf("3"))
 //gera o índice associado ao dígito colocado, no exemplo fora colocado o dígito 3
 ...
 // /\d/ : substiui todos os dígitos usando esse símbolo - reject
